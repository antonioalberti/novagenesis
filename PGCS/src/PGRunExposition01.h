...
class PGRunExposition01 : public Action {
 public:

  // Constructor
  PGRunExposition01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~PGRunExposition01 ();
