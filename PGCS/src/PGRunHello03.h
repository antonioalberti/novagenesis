...
class PGRunHello03 : public Action {
 public:

  // Constructor
  PGRunHello03 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~PGRunHello03 ();
