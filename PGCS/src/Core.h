...
class Core : public Block {
 ...
 public:
  ...
  double DelayBeforeFirstPeriodic;
  ...
  OutputVariable *tsmiup1; // Delay since instantiation at arriving on PGCS up to the final -run --evaluate for message type 1 (seconds)
