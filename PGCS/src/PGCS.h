...
public:
  ...
  // Constructor
  PGCS(string _LN, key_t _Key, string _flag, string _Port, string _Role, vector<string>* _Stacks, vector<string>* _Roles, vector<string>* _Interfaces, vector<string>* _Identifiers, vector<unsigned int>* _Sizes, string _Path);
