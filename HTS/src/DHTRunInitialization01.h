...
#define _DHTRUNINITIALIZATION01_H
...
class DHTRunInitialization01 : public Action {
 public:

  // Constructor
  DHTRunInitialization01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~DHTRunInitialization01 ();
