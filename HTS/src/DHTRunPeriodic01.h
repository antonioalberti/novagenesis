...
class DHTRunPeriodic01 : public Action {
 public:

  // Constructor
  DHTRunPeriodic01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~DHTRunPeriodic01 ();
