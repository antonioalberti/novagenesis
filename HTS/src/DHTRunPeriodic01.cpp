...
DHTRunPeriodic01::DHTRunPeriodic01(string _LN, Block* _PB, MessageBuilder* _PMB)
    : Action(_LN, _PB, _PMB)
{
  PGCSPID = "unknown";
...
int DHTRunPeriodic01::Run(Message* _ReceivedMessage, CommandLine* _PCL, vector<Message*>& ScheduledMessages, Message*& InlineResponseMessage)
{
  int Status = ERROR;
  string Offset = "                    ";
  DHT* PDHT = 0;
...
int DHTRunPeriodic01::Exposition()
{
  ...
  PMB->NewStoreBindingCommandLineFromHashLNToSCN("0.1", 2, "DHT", PB->GetSelfCertifyingName(), ExposingInitialBinds, PCL);
