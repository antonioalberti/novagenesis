...
class NRMessageType01 : public Action {
 public:

  // Constructor
  NRMessageType01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~NRMessageType01 ();
