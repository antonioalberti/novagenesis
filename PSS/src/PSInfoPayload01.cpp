/*
	...
	Name:		PSInfoPayload01
	Object:		PSInfoPayload01
	File:		PSInfoPayload01.cpp
...
PSInfoPayload01::PSInfoPayload01 (string _LN, Block *_PB, MessageBuilder *_PMB) : Action (_LN, _PB, _PMB)
{
}

PSInfoPayload01::~PSInfoPayload01 ()
{
}
...
int
PSInfoPayload01::Run (Message *_ReceivedMessage, CommandLine *_PCL, vector<Message *> &ScheduledMessages, Message *&InlineResponseMessage)
{
  int Status = ERROR;
  string Offset = "                    ";
  unsigned int NA = 0;
				  ...
				  if (PB->State == "operational")
					{
					  ...
					  //PB->S <<"The payload size of message at PSS is = "<<Size<<endl;
					  ...
					  if (Size > 0)
						{
						  ...
						  //PB->S <<"Plotting the message payload recovered by PSS"<<endl;
