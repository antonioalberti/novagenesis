...
int main (int argc, char *argv[])
{
	  ...
	  if (argc == 2)
		{
		  ...
		  cout << "*******************************************************************" << endl;
		  cout << "*                                                                 *" << endl;
		  cout << "*  NovaGenesis(NG) Publish/Subscribe Service v0.1                 *" << endl;
  ...
  if (Problem == true)
	{
	  cout << "(Usage: ./PSS Path)" << endl;
	  cout << "(Path example: /home/myprofile/workspace/novagenesis/IO/PSS/)" << endl;
	}
