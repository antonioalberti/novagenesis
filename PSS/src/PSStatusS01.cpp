...
PSStatusS01::PSStatusS01(string _LN, Block* _PB, MessageBuilder* _PMB)
    : Action(_LN, _PB, _PMB)
{
}
...
int PSStatusS01::Run(Message* _ReceivedMessage, CommandLine* _PCL, vector<Message*>& ScheduledMessages, Message*& InlineResponseMessage)
{
  int Status = ERROR;
                                                                                                  ...
                                                                                                  if (GoToOperational == true)
                                                                                                          {
                                                                                                                  ...
                                                                                                                  HashProcessLegibleName = NameGenerator::GetInstance().GenerateFromString("PSS");
