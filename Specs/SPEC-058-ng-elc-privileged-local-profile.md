...
**Status:** In Progress
**Branch:** AIOPT3
**Implementation commit:** `6a28988`, `c12692a`, `5a5877a` (profile validation, foreign-inventory gate, bounded privileged cleanup, PTY-native launch/capture, RED→GREEN tests; runtime acceptance remains open)
