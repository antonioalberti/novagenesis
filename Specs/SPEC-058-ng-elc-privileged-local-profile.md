...
**Status:** In Progress
**Branch:** AIOPT3
**Implementation commit:** `6a28988` (profile validation, privileged cleanup preflight, PTY-backed native launch/capture, RED→GREEN tests; runtime acceptance remains open)
