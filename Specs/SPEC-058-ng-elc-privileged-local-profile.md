...
**Status:** In Progress
**Branch:** AIOPT3
**Implementation commit:** `6a28988`, `c12692a` (profile validation, pre-clean ownership gate, bounded privileged cleanup, PTY-backed native launch/capture, RED→GREEN tests; runtime acceptance remains open)
