...
|---|---|---|---|---|---|---|---|
| M0 | Contrato suportado, higiene, baseline e freeze | NG-050, NG-038 | SPEC-038, SPEC-054 | — | `Specs/RESULTS-SPEC-054/g0-freeze-v4-20260914.md` | BLOCKED | Reconciliar candidato, decisão formal de fixture de teste, classificação pública e fronteira Linux/AIOPT3 |
