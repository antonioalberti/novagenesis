...
OUT=ROOT/'Specs/RESULTS-MATCHED-B/normal-100-21a5512'; OUT.mkdir(parents=True,exist_ok=True)
KEY=str(pathlib.Path.home()/'.ssh/id_ed25519_hermes'); EXPECTED='21a5512b0dc34df0c7f730805e55637144087073'
