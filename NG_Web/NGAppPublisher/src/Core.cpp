...
void Core::SetKeywordsAndTheirHashes(vector<string> arrKeywords)
{
	...
	arrKeywords.insert(arrKeywords.begin(),"App");
...
{
	return GetFileContentHash(FileName,_SCN,GetPath());
}
// Get file content hash
int Core::GetFileContentHash(string FileName, string &_SCN, string path)
{
	int 					Status=ERROR;
	File 					F1;
	...
	F1.OpenInputFile(FileName,path,"BINARY");
