...
typedef long long __intmax_tt;

/// Minimal implementation of the @c ratio class. This class provides enough
/// functionality to implement some basic @c chrono classes.
template <__intmax_tt N, __intmax_tt D = 1> class ratio {
  public:
...
namespace chrono {
  ...
  /// implement @c tthread::this_thread::sleep_for().
  ...
  typedef duration<__intmax_tt, ratio<1, 1000000000> > nanoseconds; ///< Duration with the unit nanoseconds.
  typedef duration<__intmax_tt, ratio<1, 1000000> > microseconds;   ///< Duration with the unit microseconds.
  typedef duration<__intmax_tt, ratio<1, 1000> > milliseconds;      ///< Duration with the unit milliseconds.
  typedef duration<__intmax_tt> seconds;                            ///< Duration with the unit seconds.
  typedef duration<__intmax_tt, ratio<60> > minutes;                ///< Duration with the unit minutes.
  typedef duration<__intmax_tt, ratio<3600> > hours;                ///< Duration with the unit hours.
}
