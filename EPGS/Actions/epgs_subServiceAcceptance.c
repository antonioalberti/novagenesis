...
int ActionSubscriptionServiceAcceptance(NgNetInfo* hwInfo, NgNetInfo* pgcsSCNInfo, NgScnIDInfo* pssSCNInfo, int seqNumber, char* key, NgMessage** subServiceAcceptanceMessage)
{
