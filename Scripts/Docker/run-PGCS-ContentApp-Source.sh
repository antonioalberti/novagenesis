...
docker run -itd --privileged --ipc=container:Core0 -e CA_PATH="/home/ng/workspace/novagenesis/IO/Source"$1"/" -e CA_TYPE="Source" --name Source$1 ng-contentapp:latest
...
#Copy make-photos script to create the content inside the source container (uses BuildPhotos.py)
...
docker exec -w /home/ng/workspace/novagenesis/IO/Source$1/ Source$1 sh make-photos.sh $2 $3 $4
