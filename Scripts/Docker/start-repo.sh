...
# Start NG-Repo Services
# This script initializes PGCS and ContentApp for the Repository role
...
# Start ContentApp in Repository mode
./ContentApp /home/ng/workspace/novagenesis/IO/Repository1/ Repository &
