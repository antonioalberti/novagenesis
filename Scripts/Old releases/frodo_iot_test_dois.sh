...
gnome-terminal --tab --title="PGCS" -e "/bin/bash -c 'cd $BASE/PGCS/Debug;sh clean.sh;./PGCS $BASE/IO/PGCS/ 0 Intra_Domain -pc Ethernet Intra_Domain eno1 a4:ba:db:04:31:8a 1200 Ethernet Intra_Domain eno1 e0:db:55:a1:cb:d2 1200;exec bash'" \
