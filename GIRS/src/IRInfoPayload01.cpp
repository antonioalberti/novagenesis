/*
	...
	Name:		IRInfoPayload01
	Object:		IRInfoPayload01
	File:		IRInfoPayload01.cpp
...
IRInfoPayload01::IRInfoPayload01 (string _LN, Block *_PB, MessageBuilder *_PMB) : Action (_LN, _PB, _PMB)
{
}

IRInfoPayload01::~IRInfoPayload01 ()
{
}
...
int
IRInfoPayload01::Run (Message *_ReceivedMessage, CommandLine *_PCL, vector<Message *> &ScheduledMessages, Message *&InlineResponseMessage)
{
  int Status = ERROR;
  string Offset = "                    ";
  unsigned int NA = 0;
