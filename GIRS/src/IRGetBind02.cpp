...
IRGetBind02::IRGetBind02 (string _LN, Block *_PB, MessageBuilder *_PMB) : Action (_LN, _PB, _PMB)
{
}

IRGetBind02::~IRGetBind02 ()
{
}
...
int
IRGetBind02::Run (Message *_ReceivedMessage, CommandLine *_PCL, vector<Message *> &ScheduledMessages, Message *&InlineResponseMessage)
{
  int Status = OK;
  string Offset = "                    ";
  unsigned int NA = 0;
...
int IRGetBind02::SelectHTS (string _Key, int _NumberOfInstances, int &_Index)
{
