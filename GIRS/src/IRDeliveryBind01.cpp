/*
	...
	Name:		IRDeliveryBind01
	Object:		IRDeliveryBind01
	File:		IRDeliveryBind01.cpp
...
IRDeliveryBind01::IRDeliveryBind01 (string _LN, Block *_PB, MessageBuilder *_PMB) : Action (_LN, _PB, _PMB)
{
}

IRDeliveryBind01::~IRDeliveryBind01 ()
{
}
...
// ng -d --b 0.1
int
IRDeliveryBind01::Run (Message *_ReceivedMessage, CommandLine *_PCL, vector<Message *> &ScheduledMessages, Message *&InlineResponseMessage)
{
  int Status = OK;
  string Offset = "                    ";
  unsigned int NA = 0;
				  ...
				  if (PB->State == "operational")
					{
					  ...
					  PIR->PGW->PushToInputQueue (StoreBindings);
					}
				}
			  else
				{
