...
class IRInfoPayload02 : public Action {
 public:

  // Constructor
  IRInfoPayload02 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~IRInfoPayload02 ();
