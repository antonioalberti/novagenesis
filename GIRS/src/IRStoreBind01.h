...
class IRStoreBind01 : public Action {
 public:

  // Constructor
  IRStoreBind01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~IRStoreBind01 ();
