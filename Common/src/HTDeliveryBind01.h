...
class HTDeliveryBind01 : public Action {
 public:

  // Constructor
  HTDeliveryBind01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~HTDeliveryBind01 ();
