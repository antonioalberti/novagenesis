...
class HTBindReport01 : public Action {
 public:

  // Constructor
  HTBindReport01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~HTBindReport01 ();
